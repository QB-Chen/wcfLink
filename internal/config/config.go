...
type Config struct {
	...
	AgentDailyTokenLimit   int64
	AgentMonthlyTokenLimit int64
	LLMBaseURL             string
	LLMAPIKey              string
	LLMModel               string
...
func Load() Config {
	...
	return Config{
		...
		APIToken:       envOrDefault("WCFLINK_API_TOKEN", ""),
		MediaSendRoot:  envOrDefault("WCFLINK_MEDIA_SEND_ROOT", mediaDir),
		MaxMediaBytes:  envInt64OrDefault("WCFLINK_MAX_MEDIA_BYTES", defaultMaxMediaBytes),
